...
class PrivacyPolicy extends React.Component {
  render() {
    return (
      <div className={this.props.show ? "showPrivacy" : "hidePrivacy"}>
        <i
          className="fas fa-arrow-circle-left fa-3x"
          onClick={() => this.props.resetPrivacy()}
        />
        ...
        <p>
          It is Texts From You’s policy to respect your privacy regarding any
          information we may collect while operating our website. This Privacy
          Policy applies to{" "}
          <a href="https://textsfromyou.com">https://textsfromyou.com</a>{" "}
          (hereinafter, "us", "we", or "https://textsfromyou.com"). We respect
        ...
        <p>
          Like most website operators, Texts From You collects
          non-personally-identifying information of the sort that web browsers
          and servers typically make available, such as the browser type,
          language preference, referring site, and the date and time of each
          visitor request. Texts From You’s purpose in collecting non-personally
          identifying information is to better understand how Texts From You’s
          visitors use its website. From time to time, Texts From You may
        ...
        <p>
          Texts From You also collects potentially personally-identifying
          information like Internet Protocol (IP) addresses for logged in users
          and for users leaving comments on https://textsfromyou.com blog posts.
          Texts From You only discloses logged in user and commenter IP
          addresses under the same circumstances that it uses and discloses
          personally-identifying information as described below.
        </p>
        <h2>Gathering of Personally-Identifying Information</h2>
        <p>
          Certain visitors to Texts From You’s websites choose to interact with
          Texts From You in ways that require Texts From You to gather
          personally-identifying information. The amount and type of information
          that Texts From You gathers depends on the nature of the interaction.
          For example, we ask visitors who sign up for a blog at
          https://textsfromyou.com to provide a username and email address.
        </p>
        <h2>Security</h2>
        <p>
        ...
        <p>
          ...
          Texts From You and does not cover the use of cookies by any
          advertisers.
        </p>
        ...
        <p>
          Texts From You discloses potentially personally-identifying and
          personally-identifying information only to those of its employees,
          contractors and affiliated organizations that (i) need to know that
          information in order to process it on Texts From You’s behalf or to
          provide services available at Texts From You’s website, and (ii) that
          ...
          your home country; by using Texts From You’s website, you consent to
          the transfer of such information to them. Texts From You will not rent
          ...
          affiliated organizations, as described above, Texts From You discloses
          ...
          governmental request, or when Texts From You believes in good faith
          that disclosure is reasonably necessary to protect the property or
          rights of Texts From You, third parties or the public at large.
        </p>
        <p>
          If you are a registered user of https://textsfromyou.com and have
          supplied your email address, Texts From You may occasionally send you
          an email to tell you about new features, solicit your feedback, or
          just keep you up to date with what’s going on with Texts From You and
          ...
          other users. Texts From You takes all measures reasonably necessary to
        ...
        <p>
          Texts From You may collect statistics about the behavior of visitors
          to its website. Texts From You may display this information publicly
          or provide it to others. However, Texts From You does not disclose
          your personally-identifying information.
        </p>
        <h2>Cookies</h2>
        <p>
          To enrich and perfect your online experience, Texts From You uses
        ...
        <p>
          ...
          website each time the visitor returns. Texts From You uses cookies to
          help Texts From You identify and track visitors, their usage of
          https://textsfromyou.com, and their website access preferences. Texts
          From You visitors who do not wish to have cookies placed on their
          computers should set their browsers to refuse cookies before using
          Texts From You’s websites, with the drawback that certain features of
          Texts From You’s websites may not function properly without the aid of
          cookies.
        </p>
        <p>
          By continuing to navigate our website without changing your cookie
          settings, you hereby acknowledge and agree to Texts From You's use of
          cookies.
        </p>
        <h2>Privacy Policy Changes</h2>
        <p>
          Although most changes are likely to be minor, Texts From You may
          change its Privacy Policy from time to time, and in Texts From You’s
          sole discretion. Texts From You encourages visitors to frequently
