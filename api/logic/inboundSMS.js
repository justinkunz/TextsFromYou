...
module.exports = function(snap, req){
    try {
        ...
        if(from === process.env.DEV_NUM && inbound === process.env.update_keyword){
            let dataCount = 0;
            let stopCount = 0;
            let inboundsSent = 0;
            let usingInbounds = 0;
